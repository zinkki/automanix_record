          ...
          <div className="col-lg-4 col-sm-6 mb-4" data-aos="fade-right" data-aos-delay="500">
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" onClick={()=>{window.open('https://automanix.s3.ap-northeast-2.amazonaws.com/day01.pdf')}}>
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result01.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result02.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result03.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result04.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result05.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result06.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result07.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result08.png")}
                  alt="..."
                />
              </a>
            </div>
            ...
            <div className="portfolio-item-result">
              <a className="portfolio-link-result" href="#blank01">
                ...
                <img
                  className="img-fluid"
                  src={require("../asset/img/btn-result09.png")}
                  alt="..."
                />
              </a>
            </div>
